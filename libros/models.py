...
class Autor(models.Model):
    ...
    # Reducidos a 150 para que el unique_together no supere los 1000 bytes
    ...
    class Meta:
        ...
        unique_together = ['nombre', 'apellido']  # Ya no dará error
...
class Libro(models.Model):
    ...
    # Información básica
    # Reducidos a 250 para que el index no supere los 1000 bytes
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['titulo']),  # Ya no dará error
